...
const SearchHeroCard: React.FC<IHero> = observer(({ id, selected, name, localized_name, image }) => {
	...
	return (
		...
		>
			...
			<ActivityIndicator style={{ width: scale(60), opacity: isLoading ? 1.0 : 0.0 }} size="small" color="#FFF" />
		</TouchableOpacity>
	);
});
